...
from snake_nn.evaluate_models import (
...
DEVICE_BOARD_PROFILES = {
    'phone': {
        ...
        'default_model_path': 'snake_models/profiles/phone.json',
        'export_dir': 'snake_models/exports/phone',
    },
    'pc': {
        'label': 'PC 16:9',
        'board_size_pool': [(32, 18)],
        'default_model_path': 'snake_models/profiles/pc.json',
        'export_dir': 'snake_models/exports/pc',
    },
    'tablet': {
        'label': '平板 4:3',
        'board_size_pool': [(32, 24)],
        'default_model_path': 'snake_models/profiles/tablet.json',
        'export_dir': 'snake_models/exports/tablet',
    },
}
...
BASE_IDE_CONFIG = TrainingConfig(
    ...
    # resume_from_checkpoint='snake_models/exports/phone/checkpoints/23-latest'
...
def build_profile_config(base: TrainingConfig, profile_id: str) -> TrainingConfig:
    ...
    return replace(
        ...
        checkpoint_dir=f"{profile['export_dir']}/checkpoints",
    )
