import { buildSnakeAIFeatures } from '../inference/features.js';
import { rankOutputDirections, runModel, validateModel } from '../inference/model.js';
...
export function createSnakeAIStrategy(engine, options = {}) {
    const modelUrl = options.modelUrl || '/data/models/profiles/pc.json';
