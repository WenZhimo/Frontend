...
function checkTopology(topology) {
  ...
  const checks = {
    ...
    connectedComponentAreaValid: components.componentAreas[1] === size,
    ...
    sparseComponentAreaValid: sparseComponents.componentAreas[1] === 2 && sparseComponents.componentAreas[2] === 1,
