...
function compactMetrics(name, parsed) {
  ...
  for (const key of [
    ...
    "plateCoverageMean",
    "emptyPlateCount",
    "centerSpacingMinRadians",
    "centerSpacingMeanRadians",
    "centerSpacingMinDegrees",
    "centerSpacingMeanDegrees",
    ...
    "activeSourceShare",
    "activeBoundaryShare",
    "activeBoundaryCellShare",
    "convergent",
    "divergent",
    "transform",
    "faceSeamBoundary",
    "convergentShareOfActive",
    "divergentShareOfActive",
    "transformShareOfActive",
    "faceSeamBoundaryShareOfActive",
    "sameTypeNeighborShare",
    "faceSeamSameTypeNeighborShare",
    "faceSeamBoundaryContinuityRisk",
    "stressMean",
    "stressMax",
    "faceSeamStressMean",
    ...
    "meanNearestAngularError",
    "dateLineContinuityRisk",
    "dateLineContinuityMax",
    "expectedOrthographicBlankShare",
    "orthographicBlankShareDelta",
    "northPoleHalfMapReturnDx",
    "southPoleHalfMapReturnDx",
    "northPoleHalfMapReturnValid",
    "southPoleHalfMapReturnValid",
    "northMaxAngularStep",
    "southMaxAngularStep",
    "areaTotalError",
    ...
    "coreRectangularHelperGuardCount",
    "renderRectangularPathGuardReady",
    "renderRectangularPathGuardCount",
    "scaleTopologyGuardReady",
    "scaleTopologyGuardCount",
    "topologyDiagnosticGuardReady",
    "topologyDiagnosticGuardCount",
    "resolutionSamplingGuardReady",
    "resolutionSamplingGuardCount",
    "projectionOutputIndexGuardReady",
    "projectionOutputIndexGuardCount",
    ...
    "geologyFeatureTopologyGuardCount",
    ...
    "cpuRenderBackend",
    "cpuRenderUsesSphericalProjection",
    "defaultBackendKind",
